...
String s = "schema Z2 = {"
		...
		+ "\n"
		+ "\ninstance I0:Z2 = { "
		+ "\n nodes G->{1,-1}; attributes; arrows r->{(1,-1),(-1,1)};"
		+ "\n}"
		+ "\ninstance Pi_FI0:Z4 = pi F I0"
		+ "\n"
		+ "\ninstance I1:Z2 = {"
		+ "\n nodes G->{a0,1,-1}; attributes; arrows r->{(a0,a0),(1,-1),(-1,1)};"
		+ "\n}"
		+ "\ninstance Pi_FI1:Z4 = pi F I1"
		+ "\n"
		+ "\ninstance I2:Z2 = {"
		+ "\n nodes G->{a0,b0,1,-1}; attributes; arrows r->{(a0,a0),(b0,b0),(1,-1),(-1,1)};"
		+ "\n}"
		+ "\ninstance Pi_FI2:Z4 = pi F I2"
		+ "\n"
		+ "\ninstance I3:Z2 = {"
		+ "\n nodes G->{a0,b0,c0,1,-1}; attributes; arrows r->{(a0,a0),(b0,b0),(c0,c0),(1,-1),(-1,1)};"
		+ "\n}"
		+ "\ninstance Pi_FI3:Z4 = pi F I3"
		+ "\n"
		+ "\ninstance I4:Z2 = {"
		+ "\n nodes G->{a0,b0,c0,d0,1,-1}; attributes; arrows r->{(a0,a0),(b0,b0),(c0,c0),(d0,d0),(1,-1),(-1,1)};"
		+ "\n}"
