...
public class Examples {
	...
	public static Example[] examples = new Example[] { people, external,
			...
			dihedral, empty, foil, typedFoil, sql2fql, weird,
			typedWeird, relative, sotgd, plusSig, products };
	...
	public static final String helpString = "See the People example for a tutorial, and the All syntax example for all possible FQL syntax."
			...
			+ "\n"
			+ "\nCREATE TABLE statements generated by instances can be suppressed using the keyword \"external\" (see External example)"
			+ "\n"
			...
			+ "\ndist1 A B C : A * (B + C) -> (A * B) + (A * C)"
			+ "\ndist2 A B C : (A * B) + (A * C) -> A * (B + C)"
			+ "\n"
