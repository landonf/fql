 ...
 * @author ryan
 *
 * Parser for isomorphisms commands.
 */
public class IsosCommandParser implements Parser<Command> {

	@Override
	public Partial<Command> parse(Tokens s) throws BadSyntax, IllTyped {
		Parser<?> sep = new KeywordParser("isos");
		...
		return new Partial<Command>(x.tokens, new IsosCommand(lhs + " isos " + rhs, lhs, rhs));
