...
public class PSMEval extends PSM {
	...
	public void exec(PSMInterp interp,
		...
		try {
		Quad<Instance, Map<Node, Map<Object, Transform>>, Map<Node, Triple<Instance, Map<Object, Pair<Object, Object>>, Map<Pair<Object, Object>, Object>>>, Pair<Map<Node, Triple<Instance, Map<Object, Path>, Map<Path, Object>>>, Map<Edge, Transform>>> xxx = interp.exps.get(AB);
		...
		//Instance ab = new Instance(sig, PSMGen.gather(AB, sig, state)); //already have in interp
		...
		for (Node n : sig.nodes) {
			...
			Triple<Instance, Map<Object, Pair<Object, Object>>, Map<Pair<Object, Object>, Object>> m2 = map2.get(n);
	...
	private Object lookup(Set<Pair<Object, Object>> data,
			Object first) {
