...
public class Signature implements Viewable<Signature> {
	...
	public Signature(String s, List<Node> n, LinkedList<Edge> e, Set<Eq> ee) {
		name0 = s;
		nodes = n;
		edges = e;
		eqs = ee;
...
//	public Pair<FinCat<String, List<List<String>>>, Pair<Pair<Map<String, String>, Map<String, String>>, Pair<Map<String, Arr<String, List<List<String>>>>, Map<Arr<String, List<List<String>>>, String>>>> toCategory()
//			throws FQLException {
//		if (!acyclic()) {
...
//					Arr<String, List<List<String>>> c = new Arr<>(compose(
//							a.arr, b.arr), a.src, b.dst);
//					Arr<String, List<List<String>>> c0 = new Arr<>(
//							subsetLookup(c.arr, eqcs), a.src, b.dst);
//					if (!arrows.contains(c0)) {
//						throw new RuntimeException(
//								"Not closed under composition. Computed: " + c
//										+ " ; found " + c0 + " category is "
//										+ eqcs);
//					}
...
//			for (List<List<String>> eqc : eqcs) {
//				if (eqc.contains(x)) {
//					identities.put(n.string, new Arr<>(eqc, srcOf(eqc),
//							dstOf(eqc)));
//				}
//			}
//		}
...
//					arrowIso1.put(e.name,
//							new Arr<>(eqc, srcOf(eqc), dstOf(eqc)));
//					arrowIso2.put(new Arr<>(eqc, srcOf(eqc), dstOf(eqc)),
//							e.name);
//				}
//			}
//		}
//
//		Pair<Map<String, String>, Map<String, String>> x = new Pair<>(objIso1,
//				objIso2);
//		Pair<Map<String, Arr<String, List<List<String>>>>, Map<Arr<String, List<List<String>>>, String>> y = new Pair<>(
//				arrowIso1, arrowIso2);
//
//		Pair<Pair<Map<String, String>, Map<String, String>>, Pair<Map<String, Arr<String, List<List<String>>>>, Map<Arr<String, List<List<String>>>, String>>> ret2 = new Pair<>(
//				x, y);
//
//		FinCat<String, List<List<String>>> ret = new FinCat<>(objects, arrows,
...
//	}
	...
	public Signature onlyObjects() {
		return new Signature("Obj(" + name0 + ")", nodes,
				new LinkedList<Edge>(), new HashSet<Eq>());
	}
