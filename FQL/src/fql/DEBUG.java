...
public class DEBUG implements Serializable {
	...
	public boolean ALLOW_NULLS = false;
	...
	public int MAX_DENOTE_ITERATIONS = 1024;
	...
	public void showOptions() {
		...
		JLabel label7 = new JLabel("Maximum iterations for category computation:");
		...
		areaLabel2.setToolTipText("Sets the directory for the file chooser to open on.");
		p.add(fileLabel);
		p.add(fileArea);
