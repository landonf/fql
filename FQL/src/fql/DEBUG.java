...
public class DEBUG {
	...
	public static String prelude = "DROP DATABASE FQL; CREATE DATABASE FQL; USE FQL; SET @guid := 0;"; 

	public static String jdbcUrl = "jdbc:mysql://localhost:3306/fql?user=root";
	public static boolean useJDBC = false;
	...
	public static boolean transform_textual = true;
	...
	public static void showOptions() {
		...
		jdbcLabel.setToolTipText("Causes FQL to execute the generated SQL against a JDBC connection.");
		p.add(jdbcLabel);
		p.add(jdbcBox);
		...
		int ret = JOptionPane.showConfirmDialog(null, p, "Options",
