...
public class PrettyPrinter {
	...
	public static String sep(String delim, String l, String r,
			List<? extends Jsonable> o) {
		return l + sep(delim, o) + r;
	}

	public static String sepX(String delim, String l, String r,
			List<? extends Jsonable> o, String a, String b) {
		return l + sepX(delim, o, a, b) + r;
	}

	public static String sepX(String delim, List<? extends Jsonable> o,
			String a, String b) {
		if (o.size() == 0) {
			return "";
		}
