...
public class ConstantInstanceDeclParser implements Parser<Decl> {
	...
	Parser<List<Pair<String, List<Pair<String, String>>>>> make(String name, boolean refl) {
		...
		return ParserUtils.outside(new KeywordParser(name), u, new KeywordParser(";"));
	}
...
//		
//		Parser<List<Pair<String, List<Pair<String, String>>>>> uX = ParserUtils.manySep(new TableDeclParser2(), sep);
