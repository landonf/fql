...
public class JsonPanel {
	...
	public static JPanel makePanel(final BackEnd back) {
		...
		q1.add(p1);
		q1.setBorder(BorderFactory.createTitledBorder(BorderFactory.createLineBorder(Color.black), "Instance"));
		final JTextArea a2 = new JTextArea(48,48);
		JScrollPane p2 = new JScrollPane(a2);
		JPanel q2 = new JPanel(new GridLayout(1,1));
		q2.add(p2);
		q2.setBorder(BorderFactory.createTitledBorder(BorderFactory.createLineBorder(Color.black), "Mapping/Instance"));
		final JTextArea resp = new JTextArea(48,48);
		JScrollPane p3 = new JScrollPane(resp);
		JPanel q3 = new JPanel(new GridLayout(1,1));
		q3.add(p3);
		q3.setBorder(BorderFactory.createTitledBorder(BorderFactory.createLineBorder(Color.black), "Result"));
